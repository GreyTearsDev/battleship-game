...
;// CONCATENATED MODULE: ./src/modules/sound.js


 

function sfx() {
  const low = new howler.Howl({
    src: ['../sound/sfx/low-bubble.wav']
  });
  
  const high = new howler.Howl({
    src: ['../sound/sfx/high-bubble.wav']
  });
  
  const dry = new howler.Howl({
    src: ['../sound/sfx/dry-click.mp3']
  });
...
function music() {
  const background = new Howl({
    src: ['../sound/music/ambient-guitar-by-william-king.mp3']
  });
